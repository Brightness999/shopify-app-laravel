    ...
    <div class="maincontent">
        <div class="wrapinsidecontent">
            ...
            <div class="alertan">
                <div class="agrid">
                    <img src="/img/infogray.png" srcset="/img/infogray@2x.png 2x,/img/infogray@3x.png 3x">
                    <p><a href="/plans">Click here to get a GDS membership.</a></p>
                </div>
            </div>
            @endif
            @if (session('status'))
            <div class="alert alert-success text-center h4" role="alert">
                {{ session('status') }}
                <i class="fa fa-close text-secondary float-right" style="padding-top: 2px;" aria-hidden="true"></i>
            </div>
            @endif
            ...
            <div class="threecols">
                <div class="wbox">
                    ...
                    <h2>GreenDropShip membership</h2>
                    <p>Get a GreenDropShip membership to start selling.</p>
                    @if($user->plan == null)
                    <p class="clickhere"><a href="/plans">Get Membership</a></p>
                    @else
                    <p class="clickhere">Connected to the app</p>
                    @endif
                </div>
                <div class="wbox">
                    ...
                    <p>Upgrade your plan to have more features.</p>
                    <p class="clickhere"><a href="/plans">Current Plan</a></p>
                </div>
                <div class="wbox">
                    @if($my_products_count)
                    <div class="greencheck">
                        <img src="/img/checkgreen.png">
                    </div>
                    @endif
                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 269 335" style="max-width: 97px;">
            ...
            <div class="contentbox">
                ...
                <div class="content">
                    <p class="text-center my-4">Here are some important actions you should take to use the app:</p>
                    <ul class="wcheck">
                        <li>
