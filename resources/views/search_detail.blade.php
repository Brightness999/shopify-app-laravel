        ...
        <div class="wrapinsidecontent">
            ...
            <div class="productbox">
                ...
                <div>
                    ...
                    <a href="https://{{Auth::user()->shopify_url}}/admin/products/{{$product->id_shopify}}" target="_blank"><button class="addtoimport btn_import_list_detail edit-on-shopify-{{ $product->id_shopify }}">Edit in Shopify<img class="button-icon" src="/img/edit.png" alt="Pencil in Square - Edit Icon"></button></a>
                    @endif
                </div>
            </div>
        </div>
