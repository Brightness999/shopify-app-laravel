...
@if(Auth::user()->membership_token == '')
            ...
            <div class="colsplan2">
              <div class="titlecol">
                    ...
                    <button id="btnSubmitToken">Activate</button></p>
              ...
              <button data-plan="free" class="bgVO colorBL update">Downgrade</button>
                    ...
                    <div>
                      ...
                      <div class="buttonsp">
								...
								<button data-plan="basic" class="bgVO colorBL update">Update</button>
								...
								<button data-plan="buttonBasic" data-id='2' class="bgVO colorBL buttonDisabled">Update</button>
...
/*
      if(plan == 'free'){
        window.location.href = "{{url('/plans/update-plan?p=free')}}";
      }
